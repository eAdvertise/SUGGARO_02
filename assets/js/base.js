...
if (Suggaro.Dark_Mode.default) {
    pageBody.classList.add("dark-mode-active");
}

// Night Mode
if (Suggaro.Dark_Mode.night_mode.enable) {
    var nightStart = Suggaro.Dark_Mode.night_mode.start_time;
    var nightEnd = Suggaro.Dark_Mode.night_mode.end_time;
...
if (Suggaro.Dark_Mode.auto_detect.enable)
...
function testMode() {
    ...
    console.clear();
    console.log("%cMobilekit (v" + Suggaro.version + ")", "font-size: 1.3em; font-weight: bold; color: #FFF; background-color: #1E74FD; padding: 14px 70px; margin-bottom: 16px;")
    ...
    testModeMsg(Suggaro.PWA.enable, "PWA")
    testModeMsg(Suggaro.Dark_Mode.default, "Set dark mode as default theme")
    testModeMsg(Suggaro.Dark_Mode.night_mode.enable, "Night mode (between " + Suggaro.Dark_Mode.night_mode.start_time + ":00 and " + Suggaro.Dark_Mode.night_mode.end_time + ":00)")
    testModeMsg(Suggaro.Dark_Mode.auto_detect.enable, "Auto detect dark mode")
    testModeMsg(Suggaro.RTL.enable, "RTL")
    testModeMsg(Suggaro.Test.enable, "Test mode")
    testModeMsg(Suggaro.Test.alert, "Test mode alert")
